 ...
 * @author A.Embaby
 */
@WebServlet(name = "HRop", urlPatterns = {"/HRop"})
public class HRop extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Exam e=new Exam();
             e.setExam_name(request.getParameter( "exam"));
              ...
              e.setExam_name(request.getParameter( "exam_type"));
                out.print(request.getParameter( "exam_type"));

                if(e.Exam_name(request.getParameter("exam") ,request.getParameter( "exam_type") ))
                {
                    Exam us = new Exam();
...
//out.print(request.getParameter("user"));
                ...
                else
                {
                    ...
                    out.println("<a href=\"add_exam.jsp\">Try again...</a>");
                }   
        }
    }
